          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="mt-1 block w-full rounded-md border-earth-300 dark:border-earth-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-earth-700 dark:text-earth-100"
              />
            </div>
